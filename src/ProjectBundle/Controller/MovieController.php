...
class MovieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProjectBundle:Movie')->findAll();

        return $this->render('ProjectBundle:Movie:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ProjectBundle:Movie:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProjectBundle:Movie')->find($id);
        ...
        return $this->render('ProjectBundle:Movie:show.html.twig', array(
            'entity'      => $entity,
	...
	public function showBySlugAction($slug)
    {
        ...
        $entity = $em->getRepository('ProjectBundle:Movie')->findOneBySlug($slug);
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ProjectBundle:Movie:edit.html.twig', array(
            'entity'      => $entity,
